      ...
      <div className="relative w-full overflow-hidden rounded-[35.584px]">
        ...
        <div className="absolute inset-0">
          <div className="absolute left-[clamp(16px,2.5vw,32px)] top-2/4 -translate-y-2/4 w-[clamp(300px,38vw,520px)] overflow-hidden rounded-[clamp(24px,2.6vw,32px)] bg-[#A88C62]/65 p-[clamp(18px,2.2vw,28px)] backdrop-blur-[32px] md:left-10 md:h-[372px] md:w-[678px] md:rounded-[40px] md:bg-[rgba(0,0,0,0.37)] md:p-8 md:backdrop-blur-[32px] md:backdrop-saturate-150 md:flex md:flex-col md:justify-start">
            ...
            <div className="static text-black text-base normal-nums font-normal box-content caret-black block flex-row justify-normal leading-[normal] outline-black w-auto left-auto top-auto text-center md:translate-y-[7px] md:text-left md:text-white md:text-[20px] md:font-medium md:leading-[32px] md:w-full">
