...
export const HeroContactInfo = () => {
  return (
    <div className="static [align-items:normal] box-content caret-black gap-x-[normal] block flex-row justify-normal outline-black gap-y-[normal] right-auto top-auto md:absolute md:left-1/2 md:-translate-x-1/2 md:items-end md:aspect-auto md:box-border md:caret-transparent md:gap-x-[2.176px] md:flex md:flex-col md:justify-center md:outline-[oklab(0.708_0_0_/_0.5)] md:overscroll-x-auto md:overscroll-y-auto md:gap-y-[2.176px] md:snap-align-none md:snap-normal md:snap-none md:decoration-auto md:underline-offset-auto md:[mask-position:0%] md:bg-left-top md:scroll-m-0 md:scroll-p-[auto] md:top-[35.584px]">
