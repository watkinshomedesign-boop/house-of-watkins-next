export const HeroDescription = (props: { cms?: { subhead?: string } }) => {
  ...
  return (
    <div className="static [align-items:normal] box-content caret-black gap-x-[normal] block flex-row justify-normal leading-[normal] outline-black gap-y-[normal] w-auto left-auto top-auto md:absolute md:items-start md:aspect-auto md:box-border md:caret-transparent md:gap-x-[1.792px] md:flex md:flex-col md:justify-start md:leading-[0px] md:outline-[oklab(0.708_0_0_/_0.5)] md:overscroll-x-auto md:overscroll-y-auto md:gap-y-[8px] md:snap-align-none md:snap-normal md:snap-none md:decoration-auto md:underline-offset-auto md:w-[456.832px] md:[mask-position:0%] md:bg-left-top md:scroll-m-0 md:scroll-p-[auto] md:left-[56.832px] md:top-[340px]">
