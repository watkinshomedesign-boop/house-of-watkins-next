export type ViewKey = "front" | "plan";
...
export const ViewToggle = (props: ViewToggleProps) => {
  const value = props.value ?? "front";
  const onChange = props.onChange ?? (() => {});

  return (
    <div className="static text-base [align-items:normal] box-content caret-black gap-x-[normal] block basis-auto grow-0 shrink justify-normal leading-[normal] min-h-0 min-w-0 outline-black gap-y-[normal] md:relative md:text-[14.208px] md:items-center md:aspect-auto md:box-border md:caret-transparent md:gap-x-[17.792px] md:flex md:basis-0 md:grow md:shrink-0 md:justify-end md:leading-[21.312px] md:min-h-px md:min-w-px md:outline-[oklab(0.708_0_0_/_0.5)] md:overscroll-x-auto md:overscroll-y-auto md:gap-y-[17.792px] md:snap-align-none md:snap-normal md:snap-none md:decoration-auto md:underline-offset-auto md:[mask-position:0%] md:bg-left-top md:scroll-m-0 md:scroll-p-[auto]">
        ...
        <button
          ...
          className={
            value === "front"
              ...
              : "static bg-zinc-100 caret-black inline-block shrink h-auto min-h-0 min-w-0 outline-black rounded-none md:relative md:aspect-auto md:bg-stone-50 md:caret-transparent md:block md:shrink-0 md:h-[42.624px] md:min-h-[auto] md:min-w-[auto] md:outline-[oklab(0.708_0_0_/_0.5)] md:overscroll-x-auto md:overscroll-y-auto md:snap-align-none md:snap-normal md:snap-none md:decoration-auto md:underline-offset-auto md:[mask-position:0%] md:bg-left-top md:p-0 md:scroll-m-0 md:scroll-p-[auto] md:rounded-[44.416px]"
          }
        >
