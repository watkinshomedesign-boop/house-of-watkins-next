...
export const HouseCard = (props: HouseCardProps) => {
  return (
    <div className="static text-base bg-transparent box-content caret-black basis-auto grow-0 leading-[normal] min-h-0 min-w-0 outline-black w-auto rounded-none md:relative md:h-[484px] md:w-[424px] md:shrink-0 md:text-[14.208px] md:aspect-auto md:bg-stone-50 md:box-border md:caret-transparent md:leading-[21.312px] md:min-h-px md:min-w-px md:outline-[oklab(0.708_0_0_/_0.5)] md:overscroll-x-auto md:overscroll-y-auto md:snap-align-none md:snap-normal md:snap-none md:decoration-auto md:underline-offset-auto md:[mask-position:0%] md:bg-left-top md:scroll-m-0 md:scroll-p-[auto] md:rounded-[35.584px]">
